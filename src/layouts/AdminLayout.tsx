...
export default function AdminLayout({
  ...
  return (
    <div class="relative z-1 min-h-screen flex flex-col">
      <header
        class="sticky top-0 z-30 flex flex-col border-b"
        style="background:var(--header-bg);border-color:var(--border);"
      >
        <div class="max-w-5xl mx-auto w-full px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div class="flex items-center gap-6">
            <a
              href="/"
              class="font-semibold transition-opacity hover:opacity-80 flex items-center gap-1.5"
              style={{
                color: 'var(--text)',
            ...
            <a
              href="/admin"
              class="font-medium transition-opacity hover:opacity-80 inline-flex items-center gap-1"
              style={{
                color: 'var(--text-muted)',
                'font-size': 'var(--text-sm)',
                'font-family': 'var(--font-mono)',
            ...
            >
              管理
              <span class="admin-header-cute select-none" aria-hidden="true">
                ✨
              </span>
            </a>
          </div>
          <nav class="hidden lg:flex items-center gap-5" aria-label="管理导航">
            {navItems.map((item) => (
              ...
              >
                <span class="nav-symbol" style={{ color: 'var(--accent)' }}>
                  ›
                </span>
                {item.title}
              </a>
        ...
        <div
          class="lg:hidden border-t px-4 sm:px-6 py-2.5 overflow-x-auto"
