...
本站是一个基于 **Astro** 构建的静态博客站点，用于发布技术文章、学习笔记与资源整理。内容以 Markdown / MDX 编写，支持分类、标签、归档与全文搜索，界面采用终端 / 代码风格，方便阅读与导航。
...
- **Astro 5** — 主框架，静态生成 + 按需岛屿，首屏无多余 JS
- **Tailwind CSS 4** — 样式与布局，配合 `@tailwindcss/typography` 排版文章
- **Node 适配器** — 使用 `@astrojs/node`，支持 middleware 等能力
...
- **React** — 已集成，可在页面或 MDX 中使用 React 组件
...
- **归档** — 按年 / 月分组的文章列表
- **分类与标签** — 按分类、标签筛选文章
- **文章页** — Markdown 渲染、目录（TOC）、代码高亮、版权与链接说明（CC BY-NC-SA 4.0）
- **关于博主** — 作者介绍（本页为「关于本站」）
- **友情链接** — 友链列表，终端风格展示
